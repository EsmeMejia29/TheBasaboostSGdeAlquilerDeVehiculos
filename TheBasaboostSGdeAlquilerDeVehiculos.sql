...
CREATE TABLE EMPLEADO(
	...
	id_puesto TINYINT,
	FOREIGN KEY(id_puesto) REFERENCES PUESTO_EMPLEADO(id_puesto)
);
...
ALTER TABLE MANTENIMIENTO ADD FOREIGN KEY(id_empleado) REFERENCES EMPLEADO(id_empleado) ON DELETE CASCADE; --lisot
ALTER TABLE MANTENIMIENTO ADD FOREIGN KEY(matricula) REFERENCES VEHICULOS(matricula) ON DELETE CASCADE; --listo

-- PARA "RESERVA"
ALTER TABLE RESERVA ADD FOREIGN KEY (id_cliente) REFERENCES CLIENTE(id_cliente) ON DELETE CASCADE;
ALTER TABLE RESERVA ADD FOREIGN KEY (matricula) REFERENCES VEHICULO(matricula)
