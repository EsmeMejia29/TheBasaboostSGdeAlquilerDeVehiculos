...
ALTER TABLE VEHICULOS FOREIGN KEY (id_marca) REFERENCES MARCA_VEHICULO(id_marca) ON DELETE CASCADE;
ALTER TABLE VEHICULOS FOREIGN KEY (id_modelo) REFERENCES MODELO_VEHICULO(id_modelo) ON DELETE CASCADE;
